...
const CITY_OPTIONS = [
  ...
  '南京', '天津', '西安', '长沙', '郑州', '苏州', '东莞', '佛山',
];

const DISTRICT_OPTIONS: Record<string, string[]> = {
  '北京': ['朝阳区', '海淀区', '东城区', '西城区', '丰台区', '通州区', '大兴区'],
  '上海': ['浦东新区', '黄浦区', '静安区', '徐汇区', '长宁区', '杨浦区', '闵行区'],
  '广州': ['天河区', '越秀区', '海珠区', '荔湾区', '白云区', '番禺区'],
  '深圳': ['南山区', '福田区', '罗湖区', '宝安区', '龙岗区', '龙华区'],
  '杭州': ['西湖区', '上城区', '拱墅区', '滨江区', '余杭区', '萧山区'],
  '成都': ['锦江区', '武侯区', '青羊区', '金牛区', '高新区', '成华区'],
  '重庆': ['渝中区', '江北区', '南岸区', '渝北区', '沙坪坝区', '九龙坡区'],
  '武汉': ['武昌区', '汉口区', '汉阳区', '洪山区', '江岸区'],
  '南京': ['玄武区', '秦淮区', '鼓楼区', '建邺区', '江宁区'],
  '天津': ['和平区', '南开区', '河西区', '河东区', '河北区'],
  '西安': ['雁塔区', '碑林区', '未央区', '莲湖区', '长安区'],
  '长沙': ['芙蓉区', '天心区', '岳麓区', '开福区', '雨花区'],
  '郑州': ['金水区', '中原区', '二七区', '郑东新区'],
  '苏州': ['姑苏区', '吴中区', '相城区', '虎丘区', '工业园区'],
  '东莞': ['莞城区', '东城区', '南城区', '万江区'],
  '佛山': ['禅城区', '南海区', '顺德区', '三水区'],
};
